...
>(({ className, variant = "default", ...props }, ref) => (
  <ToastPrimitive.Root
    ref={ref}
    className={cn(
      "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden border p-5 shadow-lg transition-all",
      ...
      variant === "success" && "border-black bg-black text-white",
      variant === "error" && "border-[#1a1a1a] bg-[#fafafa] text-black",
      variant === "default" && "border-[#e5e5e5] bg-white text-black",
      className
    )}
    {...props}
  />
